...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/nf-bulletin-board-all.css?1.10.0" type="text/css" />
...
<link rel="stylesheet" href="css/nf-common-ui.css?1.10.0" type="text/css" />
        ...
        <script type="text/javascript" src="js/nf/bulletin-board/nf-bulletin-board-all.js?1.10.0"></script>
    </head>
