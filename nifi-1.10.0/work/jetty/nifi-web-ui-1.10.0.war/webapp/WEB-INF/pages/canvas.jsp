...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/nf-canvas-all.css?1.10.0" type="text/css" />
<link rel="stylesheet" href="css/message-pane.css?1.10.0" type="text/css" />
<link rel="stylesheet" href="css/nf-common-ui.css?1.10.0" type="text/css" />
        ...
        <link rel="stylesheet" href="js/jquery/nfeditor/jquery.nfeditor.css?1.10.0" type="text/css" />
        <link rel="stylesheet" href="js/jquery/nfeditor/languages/nfeditor.css?1.10.0" type="text/css" />
        <link rel="stylesheet" href="js/jquery/tabbs/jquery.tabbs.css?1.10.0" type="text/css" />
        <link rel="stylesheet" href="js/jquery/combo/jquery.combo.css?1.10.0" type="text/css" />
        <link rel="stylesheet" href="js/jquery/propertytable/jquery.propertytable.css?1.10.0" type="text/css" />
        <link rel="stylesheet" href="js/jquery/tagcloud/jquery.tagcloud.css?1.10.0" type="text/css" />
        <link rel="stylesheet" href="js/jquery/modal/jquery.modal.css?1.10.0" type="text/css" />
        <link rel="stylesheet" href="js/jquery/statusbar/jquery.statusbar.css?1.10.0" type="text/css" />
        ...
        <script type="text/javascript" src="js/jquery/tabbs/jquery.tabbs.js?1.10.0"></script>
        <script type="text/javascript" src="js/jquery/combo/jquery.combo.js?1.10.0"></script>
        <script type="text/javascript" src="js/jquery/modal/jquery.modal.js?1.10.0"></script>
        ...
        <script type="text/javascript" src="js/nf/nf-namespace.js?1.10.0"></script>
        <script type="text/javascript" src="js/nf/nf-ng-namespace.js?1.10.0"></script>
        <script type="text/javascript" src="js/nf/canvas/nf-ng-canvas-namespace.js?1.10.0"></script>
        <script type="text/javascript" src="js/nf/canvas/nf-canvas-all.js?1.10.0"></script>
        <script type="text/javascript" src="js/jquery/nfeditor/languages/nfel.js?1.10.0"></script>
        <script type="text/javascript" src="js/jquery/nfeditor/languages/nfpr.js?1.10.0"></script>
        <script type="text/javascript" src="js/jquery/nfeditor/jquery.nfeditor.js?1.10.0"></script>
        <script type="text/javascript" src="js/jquery/propertytable/jquery.propertytable.js?1.10.0"></script>
        <script type="text/javascript" src="js/jquery/tagcloud/jquery.tagcloud.js?1.10.0"></script>
        <script type="text/javascript" src="js/jquery/statusbar/jquery.statusbar.js?1.10.0"></script>
    </head>
